        ...
        : (
          <div className='container-player-static'>
            {players && players.length > 0
              ? (
                <table className='table-padding player'>
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Nombre</th>
                  ...
                  <tbody>
                    {players.map( ( player, index ) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        <td>{player.nombre}</td>
                        <td className='text-center'>{player.goles}</td>
              ...
              : (
                <SelectCategoryLoader text='Todavía no hay jugadores!'/>
              )}
          </div>
        )}
    </>
