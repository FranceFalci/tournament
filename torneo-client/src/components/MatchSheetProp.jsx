...
export const MatchSheetProp = ( { sheets, onDelete } ) => {
  return (
        ...
        ? (
          <div className='container-ficha'>
            ...
            <div className='d-flex'>
              ...
              <SheetItemLazy sheets={sheets} type='0' onDelete={onDelete} />
            </div>
            <div>
              <div className='title-tipo'>
              ...
              <SheetItemLazy sheets={sheets} type='1' onDelete={onDelete} />
            </div>
            <div>
              <div className='title-tipo'>
              ...
              <SheetItemLazy sheets={sheets} type='2' onDelete={onDelete} />
            </div>
          </div>
        )
        : (
